...
- `apps/desktop/src/main/index.ts`:
  ...
  - Boot crash-safety: `whenReady` bootstrap body wrapped in try/catch; on failure `dialog.showErrorBox('Creare failed to start', message)` + `app.quit()`.
...
- `process.resourcesPath` typed as `NodeJS.Process & { resourcesPath?: string }` instead of pulling Electron types into @creare/database.

## Files Created or Modified
- /home/sudosu/projects/creare/apps/desktop/src/main/index.ts
- /home/sudosu/projects/creare/packages/database/src/client.ts
